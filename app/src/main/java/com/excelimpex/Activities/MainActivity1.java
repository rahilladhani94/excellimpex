...
public class MainActivity1 extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if(mLocation!=null)
        {
            ...
            Toast.makeText(MainActivity1.this,"Ena",Toast.LENGTH_SHORT).show();
        }
